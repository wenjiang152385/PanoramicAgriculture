...
public class CardScaleHelper {
    ...
    private List<GalleryCallback> mGalleryCallbacks = new ArrayList<>();
    ...
    public void registerGalleryCallback(GalleryCallback galleryCallback) {
        mGalleryCallbacks.add(galleryCallback);
    }

    public void unRegisterGalleryCallback(GalleryCallback galleryCallback) {
        if (mGalleryCallbacks.contains(galleryCallback))
            mGalleryCallbacks.remove(galleryCallback);
    }

    public void setListening(int position) {
        for (int i = 0; i < mGalleryCallbacks.size(); i++) {
            mGalleryCallbacks.get(i).setCurrentPositionCallback(position);
        }
    }
}
