...
import com.oraro.panoramicagriculture.ui.activity.OrderActivity;
 ...
 * @author
 */
public class OrderPresenter extends Presenter<OrderActivity> {
    private final DaoSession daoSession = PanoramicAgricultureApplication.getInstances().getDaoSession();
    public  void adddistribution (String method, JsonObject params){
