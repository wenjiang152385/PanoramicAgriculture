...
/** 
 * DAO for table "FARM_ENTITY".
*/
public class FarmEntityDao extends AbstractDao<FarmEntity, Long> {

    public static final String TABLENAME = "FARM_ENTITY";

    /**
     * Properties of entity FarmEntity.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property FarmInfo = new Property(12, String.class, "farmInfo", false, "FARM_INFO");
        ...
        public final static Property PhoneNum = new Property(17, String.class, "phoneNum", false, "PHONE_NUM");
        public final static Property UserId = new Property(18, Long.class, "userId", false, "USER_ID");
    };


    public FarmEntityDao(DaoConfig config) {
        super(config);
    }
    
    public FarmEntityDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FARM_ENTITY\" (" + //
                ...
                "\"FARM_INFO\" TEXT," + // 12: farmInfo
                "\"SLIDE1\" TEXT," + // 13: slide1
                "\"SLIDE2\" TEXT," + // 14: slide2
                "\"SLIDE3\" TEXT," + // 15: slide3
                "\"SLIDE4\" TEXT," + // 16: slide4
                "\"PHONE_NUM\" TEXT," + // 17: phoneNum
                "\"USER_ID\" INTEGER);"); // 18: userId
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FARM_ENTITY\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, FarmEntity entity) {
        stmt.clearBindings();
        ...
        String farmInfo = entity.getFarmInfo();
        if (farmInfo != null) {
            stmt.bindString(13, farmInfo);
        }
        ...
        if (phoneNum != null) {
            stmt.bindString(18, phoneNum);
        }
 
        Long userId = entity.getUserId();
        if (userId != null) {
            stmt.bindLong(19, userId);
        }
    }

    @Override
    protected final void bindValues(SQLiteStatement stmt, FarmEntity entity) {
        stmt.clearBindings();
    ...
    @Override
    public FarmEntity readEntity(Cursor cursor, int offset) {
        FarmEntity entity = new FarmEntity( //
            ...
            cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12), // farmInfo
            ...
            cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17), // phoneNum
            cursor.isNull(offset + 18) ? null : cursor.getLong(offset + 18) // userId
        );
        return entity;
    }
     
    @Override
    public void readEntity(Cursor cursor, FarmEntity entity, int offset) {
        ...
        entity.setFarmInfo(cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12));
        ...
        entity.setPhoneNum(cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17));
        entity.setUserId(cursor.isNull(offset + 18) ? null : cursor.getLong(offset + 18));
     }
    
    @Override
    protected final Long updateKeyAfterInsert(FarmEntity entity, long rowId) {
        entity.setFarmId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(FarmEntity entity) {
        if(entity != null) {
