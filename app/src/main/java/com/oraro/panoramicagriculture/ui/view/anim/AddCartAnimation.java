package com.oraro.panoramicagriculture.ui.view.anim;
...
public class AddCartAnimation {
     ...
     */
    public static void AddToCart(final View startView, Bitmap bitmap, View endView, Context mContext, final RelativeLayout rl, final int time) {
        ...
        Log.e("jw","startLocation=="+startLocation[0]+"..."+startLocation[1]+"--endLocation=="+endLocation[0]+"..."+endLocation[1]);
