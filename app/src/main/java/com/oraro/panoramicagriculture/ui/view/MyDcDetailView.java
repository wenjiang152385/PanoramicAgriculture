 ...
 * @author
 */
public class MyDcDetailView extends LinearLayout {
    ...
    public MyDcDetailView(Context context) {
        super(context);
        mContext=context;
        initView();

    }
    public MyDcDetailView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext=context;
        initView();
    }

    public MyDcDetailView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext=context;
        initView();
    }
    private void initView() {
        View itemview = View.inflate(mContext, R.layout.item_my_dc_detail_view, this);
