 ...
 */
public class MyPointDetailView extends LinearLayout{
    ...
    public MyPointDetailView(Context context) {
        super(context);
        mContext = context;
        initView();
    }

    public MyPointDetailView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView();
    }
    protected void initView(){
        View itemview = View.inflate(mContext, R.layout.item_my_point_detail_view, this);
