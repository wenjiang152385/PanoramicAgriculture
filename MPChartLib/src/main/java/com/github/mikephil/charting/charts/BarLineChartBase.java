...
//            Log.e("wjq","mAxisLeft.mAxisMinimum=" + mAxisLeft.mAxisMinimum
//            +" mAxisLeft.mAxisMaximum="+mAxisLeft.mAxisMaximum+" | "+ mAxisLeft.isInverted());
        ...
        Log.e("base", "xxx  = " + mViewPortHandler.getContentRect());
  ...
  private void setIndicesToHighlight(int position) {
      Map<Integer,List<Highlight>> map= ((LineChartRenderer)mRenderer).getPointLists();
      mIndicesToHighlight = new Highlight[mData.getDataSetCount()];
      for (int i = 0; i < mData.getDataSetCount(); i++) {
          mIndicesToHighlight[i] = map.get(i).get(position);
      }
  }

    public void setHighLight(int position) {
        setIndicesToHighlight(position);
