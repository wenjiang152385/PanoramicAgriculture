...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
    ...
    protected void drawMarkers(Canvas canvas) {
        ...
        for (int i = 0; i < mIndicesToHighlight.length; i++) {
            ...
            // draw the marker qqww
            mMarker.draw(canvas, pos[0]+50, pos[1]);
        }
    }
     ...
     * @param easing         a predefined easing option
     */
    public void animateY(int durationMillis, Easing.EasingOption easing, AnimationEndListener animationEndListener) {
        mAnimator.animateY(durationMillis, easing,animationEndListener);
    }


    public void inverseAnimateY(int durationMillis, Easing.EasingOption easing, AnimationEndListener animationEndListener) {
        mAnimator.inverseAnimateY(durationMillis, easing, animationEndListener);
    }
     ...
     * @param durationMillis
     */
    public void animateY(int durationMillis,AnimationEndListener animationEndListener) {
        mAnimator.animateY(durationMillis,animationEndListener);
    }
    ...
    public void destoryPieChart() {
        if (getBackground() != null) {
            getBackground().setCallback(null);
        }
        if (this instanceof ViewGroup) {
            for (int i = 0; i < this.getChildCount(); i++) {
                unbindDrawables(this.getChildAt(i));
            }
            this.removeAllViews();
        }
    }
