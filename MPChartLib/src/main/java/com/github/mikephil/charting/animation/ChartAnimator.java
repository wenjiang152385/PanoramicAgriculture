...
public class ChartAnimator {
     ...
     * @param easing
     */
    public void animateY(int durationMillis, Easing.EasingOption easing, final Chart.AnimationEndListener animationEndListener) {
    ...
    public void inverseAnimateY(int durationMillis, Easing.EasingOption easing, final Chart.AnimationEndListener animationEndListener) {

        if (android.os.Build.VERSION.SDK_INT < 11)
            return;

        ObjectAnimator animatorY = ObjectAnimator.ofFloat(this, "phaseY", 1f, 0f);
        animatorY.setInterpolator(Easing.getEasingFunctionFromOption(easing));
        animatorY.setDuration(durationMillis);
        animatorY.addUpdateListener(mListener);
        animatorY.addListener(new Animator.AnimatorListener() {
     ...
     * @param durationMillis
     */
    public void animateY(int durationMillis, final Chart.AnimationEndListener animationEndListener) {
