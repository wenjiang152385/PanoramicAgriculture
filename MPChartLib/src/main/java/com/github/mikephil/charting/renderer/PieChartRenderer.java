...
public class PieChartRenderer extends DataRenderer {
    ...
    protected List<MPPointF> mpPointFList;
    public PieChartRenderer(PieChart chart, ChartAnimator animator,
        ...
        mTestPaint.setStyle(Style.FILL);
    }
...
//        Log.e("wjq","rotationAngle = " + rotationAngle);


        float phaseX = mAnimator.getPhaseX();
        float phaseY = mAnimator.getPhaseY();
//        Log.e("wjq","phaseX = " + phaseX + "phaseY = " + phaseY);
...
//            Log.e("wjq","sliceAngle = " + sliceAngle);
            ...
            if ((Math.abs(e.getY()) > Utils.FLOAT_EPSILON)) {
                ...
                if (!mChart.needsHighlight(j)) {
                    ...
                    float arcEndPointX = 0f;
                    float arcEndPointY = 0f;
...
//            c.drawCircle(x,y,10,mTestPaint);
            ...
            c.translate(boundingRect.left, y);
